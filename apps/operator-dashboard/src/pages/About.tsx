      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            The Operator Dashboard is a comprehensive control and observability platform for managing
            RoomServer, RoomOperator, and Test Client components of the Metacore Stack.
          </p>
          <p className="text-gray-600 dark:text-gray-400">
            It provides real-time event monitoring, test execution capabilities, command orchestration,
            and dynamic configuration management through an intuitive web interface.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400">
            <li className="flex items-start gap-2">
              ...
              <span><strong>Real-time Event Streaming:</strong> Monitor events from RoomServer and RoomOperator via Server-Sent Events (SSE)</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
              <span><strong>Test Execution:</strong> Run integration tests with live log streaming and artifact collection</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
              <span><strong>Command Orchestration:</strong> Execute RoomOperator commands with dynamic parameter validation</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
              <span><strong>Configuration Management:</strong> Edit and persist dashboard settings with hot reload</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
              <span><strong>System Overview:</strong> Health checks and status monitoring for all components</span>
            </li>
          </ul>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Built with modern React and TypeScript, using Vite for fast development. 
                Styled with TailwindCSS for a lightweight, responsive interface.
              </p>
            </div>
            <div>
              <h3 className="font-medium text-gray-900 dark:text-white mb-2">
